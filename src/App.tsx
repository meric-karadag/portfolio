  ...
  <div className="space-y-20 md:space-y-32 pb-20">
    ...
    <section id="contact" className="py-20 bg-white border border-[#E5E5E5] rounded-3xl overflow-hidden">
       <div className="max-w-3xl mx-auto px-6 text-center space-y-8">
         ...
         {/* Layout adjusted to be centered since form is removed */}
         <div className="flex flex-col items-center gap-8 max-w-4xl mx-auto">
            {/* Contact Info Card */}
            <div className="w-full max-w-md bg-[#F9F9F7] p-8 rounded-2xl border border-[#E5E5E5] space-y-6 text-left">
               <div>
                 ...
                 <div className="space-y-4">
                    <div className="flex items-start gap-3">
                       ...
                       <div className="space-y-1">
                          ...
                          <a href="mailto:ymerickaradag@gmail.com" className="block text-sm text-[#5C5C5C] hover:text-[#D4693F] transition-colors">ymerickaradag@gmail.com</a>
                          <a href="mailto:karadag.y@metu.edu.tr" className="block text-sm text-[#5C5C5C] hover:text-[#D4693F] transition-colors">karadag.y@metu.edu.tr</a>
                       </div>
                    </div>
                    
                    <div className="flex items-start gap-3">
                       <MapPin className="w-5 h-5 text-[#D4693F] mt-0.5 shrink-0" />
                       <div>
                          <p className="text-sm font-medium text-[#2C2C2C]">Location</p>
                          <p className="text-sm text-[#5C5C5C]">Ankara, Turkey</p>
                       </div>
                    </div>

                    <div className="flex items-start gap-3">
                       <Linkedin className="w-5 h-5 text-[#D4693F] mt-0.5 shrink-0" />
                       <div>
                          <p className="text-sm font-medium text-[#2C2C2C]">Social</p>
                          <a href="https://linkedin.com/in/meric-karadag/" target="_blank" rel="noopener noreferrer" className="text-sm text-[#5C5C5C] hover:text-[#D4693F] transition-colors">
                             LinkedIn Profile
                          </a>
                       </div>
                    </div>
            ...
            <div className="w-full bg-[#F9F9F7] p-8 rounded-2xl border border-[#E5E5E5]">
               <div className="mb-6 text-left">
                 <h3 className="text-lg font-bold text-[#2C2C2C]">Send a Message</h3>
                 <p className="text-sm text-[#5C5C5C]">Directly to my inbox.</p>
               </div>
               <ContactForm />
            </div>
            */}
